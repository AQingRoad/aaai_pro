...
RUBRIC_API_TIMEOUT=${RUBRIC_API_TIMEOUT:-300}
RUBRIC_API_MAX_RETRIES=${RUBRIC_API_MAX_RETRIES:-12}
...
print_param RUBRIC_API_RETRY "$RUBRIC_API_MAX_RETRIES retries, ${RUBRIC_API_RETRY_BASE_SECONDS}s to ${RUBRIC_API_RETRY_MAX_SECONDS}s backoff" "失败后在同一 key 上指数退避，最多等待约 9 分钟，再轮询其它 key。"
...
export COT_RUBRIC_NDCG_GAIN_API_RETRY_BASE_SECONDS="$RUBRIC_API_RETRY_BASE_SECONDS"
export COT_RUBRIC_NDCG_GAIN_API_RETRY_MAX_SECONDS="$RUBRIC_API_RETRY_MAX_SECONDS"
