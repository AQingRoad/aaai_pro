...
EVAL_DIR=${EVAL_DIR:-$ROOT/outputs/rrec_amazon/eval/$CATEGORY/$(basename "$CHECKPOINT_ROOT")_${SPLIT}${mask_suffix}_all_ckpts}
...
for checkpoint in "${CHECKPOINTS[@]}"; do
  ...
  EVAL_COT_TEXT_MODE="$EVAL_COT_TEXT_MODE" \
  EVAL_CANDIDATE_INDEX="$EVAL_CANDIDATE_INDEX" \
  EVAL_REQUIRE_COT="$EVAL_REQUIRE_COT" \
